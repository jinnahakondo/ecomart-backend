...
app.get("/", (req: Request, res: Response) => {
  ...
  const endpoints = [
    { method: "GET", path: "/", description: "API root with endpoint list" },
    ...
    { method: "GET", path: "/api/orders/user/:userId", description: "Get orders for a specific user" },
    ...
    { method: "GET", path: "/api/reviews/:email", description: "Get reviews by email" },
